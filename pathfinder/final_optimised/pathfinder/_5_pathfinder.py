...
import _0_1_merge_sort_paths as merge_sort
...
def get_travel_time(ctt_dict, weekday, time_unit, route, first, second):
	...
	return abs(abs(ctt_dict[weekday][time_unit][route][second][2]) - abs(ctt_dict[weekday][time_unit][route][first][2]))
...
def pathfinder(clean_pp_dict, ctt_dict, weekday, time_unit):
	...
	pathfinder_dict = merge_sort.merge_sort_time_key(pathfinder_dict)
