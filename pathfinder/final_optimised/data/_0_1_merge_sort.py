...
def merge_on_stop_sequence(d_1, d_2):
	"""
...
def merge_sort_stop_sequence(d_input):
	...
	if len(d_return) > 1:
		...
		for i in range(middle, length, 1):
			...
			del d_return[next_item]
		# recursion
		d_1 = merge_sort_stop_sequence(d_1)
		d_2 = merge_sort_stop_sequence(d_2)
		# sorting
		d_return = merge_on_stop_sequence(d_1, d_2)
	# return
	return d_return

def merge_sort(d_input):
	d_return = merge_sort_stop_sequence(d_input)
	return d_return