...
def merge_sort_next_for_stop_id(d_return):
	"""
	...
	if len(d_return) > 1:
		...
		for i in range(middle, length, 1):
			...
			del d_return[next_item]
		# recursion
		d_1 = merge_sort_next_for_stop_id(d_1)
		d_2 = merge_sort_next_for_stop_id(d_2)
		# sorting
		d_return = merge_dict_next_for_stop_id(d_1, d_2)
	# return
	return d_return